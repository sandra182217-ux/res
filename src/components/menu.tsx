...
export function Menu() {
  ...
  return (
    <section id="cardapio" className="py-20 lg:py-32 bg-background/80">
      <div className="container mx-auto px-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-full font-medium transition-all ${
                activeCategory === category.id
                  ...
                  : "bg-card text-foreground/80 hover:bg-card/80 hover:text-primary-foreground"
              }`}
            >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {menuItems[activeCategory]?.map((item, index) => (
            <div
              key={index}
              className="bg-card p-6 rounded-2xl border border-border/50 hover:border-primary/50 transition-all group shadow-sm"
            >
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-primary text-primary-foreground px-10 py-5 rounded-full font-bold hover:bg-primary/90 transition-all hover:scale-105 shadow-lg"
          >
