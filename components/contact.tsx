        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Telefone / WhatsApp</h3>
                <a
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-foreground mb-4">Horário de Funcionamento</h3>
                <div className="space-y-2">
                  {schedules.map((schedule, index) => (
                    <div 
                      key={index} 
                      className={`flex justify-between py-2 border-b border-border/30 ${
                        schedule.hours === "Fechado" ? "text-foreground/40" : "text-foreground/70"
                      }`}
                    >
                      <span>{schedule.day}</span>
                      <span className={schedule.hours !== "Fechado" ? "text-primary font-medium" : ""}>
                        {schedule.hours}
                      </span>
                    </div>
                  ))}
